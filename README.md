#  HR Employee Performance Analysis — SQL & PowerBI Dashboard

> A complete SQL project analyzing HR employee data using all major Window Functions in SQL Server (SSMS) and  Power BI -Used to design HR Employee Performance Dashboard for insights into  performance, and workforce analytics.
...
---
## Dashboard
![Dashboard](Visuals/HR_Employee_performance_Dashboard)
